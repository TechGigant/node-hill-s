...
const ASSET_API = (assetId: number) => `https://api.brick-hill.com/v2/assets/getPoly/1/${assetId}`
const GET_ASSET_DATA = (assetId: number) => `https://api.brick-hill.com/v2/assets/get/${assetId}`
